module reardyack;
  ...
  ap_reqrdyack :
  assert property (@(posedge clk) ($rose(req) ##1 rdy) |-> ##1 ack);
  ap_reqrdyack_bad :
  assert property (@(posedge clk) (req ##1 rdy) |-> ##1 ack);
  XXap_reqrdyack_bad :
  assert property (@(posedge clk) (req ##1 rdy) |-> 1 ##1 ack);
  ...
  initial begin
    ...
    // rea rdy ack
    {
      0, 3'b100, 3'b110, 3'b011, 0, 0, 3'b100, 3'b010, 3'b001, 0
    };
    bit v_a, v_b, v_c;
